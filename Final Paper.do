...
reg GD_RATING ROA APPROVE_CEO CASH_RATIO DEBT_EQUITY_RATIO NETDEBT_EBITDA EPS
reg GD_RATING ROE APPROVE_CEO CASH_RATIO DEBT_EQUITY_RATIO NETDEBT_EBITDA EPS
reg GD_RATING ROA APPROVE_CEO CASH_RATIO DEBT_EQUITY_RATIO NETDEBT_EBITDA EPS IQ_PROFESSIONAL_SALARY IQ_PROFESSIONAL_CALCULATED_COMP IQ_PROFESSIONAL_RESTRICTED_STOCK IQ_PROFESSIONAL_OPTION_AWARDS
reg GD_RATING ROE APPROVE_CEO CASH_RATIO DEBT_EQUITY_RATIO NETDEBT_EBITDA EPS IQ_PROFESSIONAL_SALARY IQ_PROFESSIONAL_CALCULATED_COMP IQ_PROFESSIONAL_RESTRICTED_STOCK IQ_PROFESSIONAL_OPTION_AWARDS

reg GD_RATING ROA APPROVE_CEO DEBT_EQUITY_RATIO EPS IQ_PROFESSIONAL_SALARY IQ_PROFESSIONAL_CALCULATED_COMP IQ_PROFESSIONAL_RESTRICTED_STOCK IQ_PROFESSIONAL_OPTION_AWARDS
reg GD_RATING ROE APPROVE_CEO DEBT_EQUITY_RATIO EPS IQ_PROFESSIONAL_SALARY IQ_PROFESSIONAL_CALCULATED_COMP IQ_PROFESSIONAL_RESTRICTED_STOCK IQ_PROFESSIONAL_OPTION_AWARDS

reg APPROVE_CEO ROA
reg APPROVE_CEO ROA GD_RATING CASH_RATIO
...
eststo E : reg GD_RATING ROA APPROVE_CEO DEBT_EQUITY_RATIO EPS IQ_PROFESSIONAL_SALARY IQ_PROFESSIONAL_CALCULATED_COMP IQ_PROFESSIONAL_RESTRICTED_STOCK IQ_PROFESSIONAL_OPTION_AWARDS
