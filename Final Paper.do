...
estpost summarize year GD_RATING REC_FRIEND APPROVE_CEO ROA ROE, detail
...
reg CURRENT_RATIO GD_RATING
reg CURRENT_RATIO REC_FRIEND
reg CURRENT_RATIO APPROVE_CEO
reg CURRENT_RATIO GD_RATING REC_FRIEND APPROVE_CEO

reg CASH_RATIO GD_RATING
reg CASH_RATIO REC_FRIEND
reg CASH_RATIO APPROVE_CEO
reg CASH_RATIO GD_RATING REC_FRIEND APPROVE_CEO

reg DEBT_EQUITY_RATIO GD_RATING
reg DEBT_EQUITY_RATIO REC_FRIEND
reg DEBT_EQUITY_RATIO APPROVE_CEO
reg DEBT_EQUITY_RATIO GD_RATING REC_FRIEND APPROVE_CEO

reg EQUITY_MULTIPLIER GD_RATING
reg EQUITY_MULTIPLIER REC_FRIEND
reg EQUITY_MULTIPLIER APPROVE_CEO
reg EQUITY_MULTIPLIER GD_RATING REC_FRIEND APPROVE_CEO

reg NETDEBT_EBITDA GD_RATING
reg NETDEBT_EBITDA REC_FRIEND
reg NETDEBT_EBITDA APPROVE_CEO
reg NETDEBT_EBITDA GD_RATING REC_FRIEND APPROVE_CEO

reg INVENTORY_TURNOVER GD_RATING
reg INVENTORY_TURNOVER REC_FRIEND
reg INVENTORY_TURNOVER APPROVE_CEO
reg INVENTORY_TURNOVER GD_RATING REC_FRIEND APPROVE_CEO

reg DAYS_SALES_INVENTORY GD_RATING
reg DAYS_SALES_INVENTORY REC_FRIEND
reg DAYS_SALES_INVENTORY APPROVE_CEO
reg DAYS_SALES_INVENTORY GD_RATING REC_FRIEND APPROVE_CEO

reg PROFIT_MARGIN GD_RATING
reg PROFIT_MARGIN REC_FRIEND
reg PROFIT_MARGIN APPROVE_CEO
reg PROFIT_MARGIN GD_RATING REC_FRIEND APPROVE_CEO

reg EBITDA_SALES GD_RATING
reg EBITDA_SALES REC_FRIEND
reg EBITDA_SALES APPROVE_CEO
reg EBITDA_SALES GD_RATING REC_FRIEND APPROVE_CEO

reg EPS GD_RATING
reg EPS REC_FRIEND
reg EPS APPROVE_CEO
reg EPS GD_RATING REC_FRIEND APPROVE_CEO
