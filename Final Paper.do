...
gen NI_2019 = IQ_NI_CS if year == 2019
gen assets_2018 = IQ_TOTAL_ASSETS_CS if year == 2018
gen equity_2018 = IQ_TOTAL_EQUITY_CS if year == 2018

collapse (sum) NI_2019 (mean) assets_2018 equity_2018 , by(capiq_id)

joinby capiq_id using "/Users/canaan/Desktop/GitHub/ECON387/capiq_firm_exec_comp_data.dta"

joinby capiq_id datacqtr using "/Users/canaan/Desktop/GitHub/ECON387/capiq_firm_income_data.dta"
joinby capiq_id datacqtr_ciq kypermno permco using "/Users/canaan/Desktop/GitHub/ECON387/capiq_firm_balancesheet_data.dta"
...
*ROA
gen ROA = NI_2019/assets_2018
label var ROA "ROA"

*ROE
gen ROE = NI_2019/equity_2018
label var ROE "ROE"
...
*scatter
twoway (scatter GD_RATING ROA) (lfitci GD_RATING ROA), title(Scatterplot of Employee Satisfaction and ROA) ytitle(Satisfaction Rating)
twoway (scatter GD_RATING ROE) (lfitci GD_RATING ROE), title(Scatterplot of Employee Satisfaction and ROE) ytitle(Satisfaction Rating)
...
estpost summarize GD_RATING REC_FRIEND APPROVE_CEO ROA ROE IQ_PROFESSIONAL_SALARY IQ_PROFESSIONAL_CALCULATED_COMP IQ_PROFESSIONAL_RESTRICTED_STOCK IQ_PROFESSIONAL_OPTION_AWARDS CASH_RATIO DEBT_EQUITY_RATIO NETDEBT_EBITDA INVENTORY_TURNOVER EPS, detail
...
reg GD_RATING ROA APPROVE_CEO
reg GD_RATING ROE APPROVE_CEO
*reg GD_RATING ROA REC_FRIEND APPROVE_CEO
*reg GD_RATING ROE REC_FRIEND APPROVE_CEO
reg GD_RATING ROA APPROVE_CEO IQ_PROFESSIONAL_SALARY IQ_PROFESSIONAL_CALCULATED_COMP IQ_PROFESSIONAL_RESTRICTED_STOCK IQ_PROFESSIONAL_OPTION_AWARDS
reg GD_RATING ROE APPROVE_CEO IQ_PROFESSIONAL_SALARY IQ_PROFESSIONAL_CALCULATED_COMP IQ_PROFESSIONAL_RESTRICTED_STOCK IQ_PROFESSIONAL_OPTION_AWARDS


reg GD_RATING ROA APPROVE_CEO CASH_RATIO DEBT_EQUITY_RATIO NETDEBT_EBITDA INVENTORY_TURNOVER EPS
reg GD_RATING ROE APPROVE_CEO CASH_RATIO DEBT_EQUITY_RATIO NETDEBT_EBITDA INVENTORY_TURNOVER EPS
reg GD_RATING ROA APPROVE_CEO CASH_RATIO DEBT_EQUITY_RATIO NETDEBT_EBITDA INVENTORY_TURNOVER EPS IQ_PROFESSIONAL_SALARY IQ_PROFESSIONAL_CALCULATED_COMP IQ_PROFESSIONAL_RESTRICTED_STOCK IQ_PROFESSIONAL_OPTION_AWARDS
reg GD_RATING ROE APPROVE_CEO CASH_RATIO DEBT_EQUITY_RATIO NETDEBT_EBITDA INVENTORY_TURNOVER EPS IQ_PROFESSIONAL_SALARY IQ_PROFESSIONAL_CALCULATED_COMP IQ_PROFESSIONAL_RESTRICTED_STOCK IQ_PROFESSIONAL_OPTION_AWARDS

reg GD_RATING ROA APPROVE_CEO DEBT_EQUITY_RATIO INVENTORY_TURNOVER EPS IQ_PROFESSIONAL_SALARY IQ_PROFESSIONAL_CALCULATED_COMP IQ_PROFESSIONAL_RESTRICTED_STOCK IQ_PROFESSIONAL_OPTION_AWARDS
reg GD_RATING ROE APPROVE_CEO DEBT_EQUITY_RATIO INVENTORY_TURNOVER EPS IQ_PROFESSIONAL_SALARY IQ_PROFESSIONAL_CALCULATED_COMP IQ_PROFESSIONAL_RESTRICTED_STOCK IQ_PROFESSIONAL_OPTION_AWARDS

. ssc install estout, replace
eststo A : reg GD_RATING ROA
eststo B : reg GD_RATING ROE
eststo C : reg GD_RATING ROA APPROVE_CEO
eststo D : reg GD_RATING ROA APPROVE_CEO IQ_PROFESSIONAL_SALARY IQ_PROFESSIONAL_CALCULATED_COMP IQ_PROFESSIONAL_RESTRICTED_STOCK IQ_PROFESSIONAL_OPTION_AWARDS 
eststo E : reg GD_RATING ROA APPROVE_CEO DEBT_EQUITY_RATIO INVENTORY_TURNOVER EPS IQ_PROFESSIONAL_SALARY IQ_PROFESSIONAL_CALCULATED_COMP IQ_PROFESSIONAL_RESTRICTED_STOCK IQ_PROFESSIONAL_OPTION_AWARDS 
eststo F : reg GD_RATING ROA APPROVE_CEO CASH_RATIO DEBT_EQUITY_RATIO NETDEBT_EBITDA INVENTORY_TURNOVER EPS IQ_PROFESSIONAL_SALARY IQ_PROFESSIONAL_CALCULATED_COMP IQ_PROFESSIONAL_RESTRICTED_STOCK IQ_PROFESSIONAL_OPTION_AWARDS
esttab A B C D E F using OLSreg2.doc, se r2
